...
<html>
    ...
    <body background="images/alan-king-KZv7w34tluA-unsplash.jpg">
        <div >
            ...
            <div class="container "><br>
                <div class="container">
                    ...
                    <div class="col-lg-8 d-block m-auto bg-success quizsetting card ">
                     ...
                     $sql1 = "SELECT * FROM `questions_3` WHERE `qid` = $i ";
                        ...
                        if (mysqli_num_rows($result1) > 0) {
                     	...
                     	?>
                            ...
                            <div class="card bg-dark">
                                ...
                                <?php
                        $sql = "SELECT * FROM `answers_3` WHERE `ans_id` = $i ";
                           ...
                           if (mysqli_num_rows($result) > 0) {
                        	...
                        	?>
                                ...
                                <div class="btn1 btn-primary d-block m-auto text-white">
                                    <input type="radio" class="styled " name="quizcheck3[<?php echo $row['ans_id'];?>];"
      ...
      for($i=1; $i<=$totalpage; $i++){
         ?>
                    ...
                    <li class="float-left list-unstyled page-item"> <a href="doggoQuiz.php?page=<?php echo $i; ?>"
